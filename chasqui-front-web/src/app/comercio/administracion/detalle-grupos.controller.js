(function() {
	...
	function DetalleGruposController($http, $log, $scope, $q, $timeout,restProxy, CTE_REST) {
		$log.debug("controler DetalleGruposController inti grupo ",$scope.idGrupo)
		var vm = this;
		...
		/** Trae la lista de los integrantes del grupo y de los contactos podibles */
		//TODO : cambiar la lista de contactos por un boton que pida en ingreso al grupo por mail.
