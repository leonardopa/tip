...
public class ProductoServiceMock {
	...
	public List<ProductoDto> findProductosDestacados() {
		return findProductos(10, 1, 1);
	}

	public List<ProductoDto> findProductos() {
		return findProductos(10, 2, 3);
	}

	private List<ProductoDto> findProductos(int x, int cantVariantes, int cantCategorias) {
	...
	//	producto.setDescripcionVariente("descripcionVariente" + idVariante);
		...
		producto.setNombreVariedad("nombreVariedad" + idVariante);
